...
common_index = (
    ...
    .intersection(robust_ceir_wasserstein_cumulative.index)
...
common_index = (
    ...
    .intersection(robust_ceir_wasserstein_l0_norm.index)
...
if ("solve_time_seconds" in ceir_optimization_history.columns 
    ...
    and "solve_time_seconds" in robust_ceir_wasserstein_optimization_history.columns
    ...
    common_index = (
        ...
        .intersection(robust_ceir_wasserstein_optimization_history.index)
    )
