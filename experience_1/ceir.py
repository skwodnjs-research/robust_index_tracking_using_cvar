...
for rebalance_year in rebalance_years:
    ...
    try:
        w_value, objective_value, status = solve_ceir(
...
weight_history.to_csv(f"data/data_{index}_ceir_weights.csv")
optimization_history.to_csv(f"data/data_{index}_ceir_optimization_history.csv")
backtest_returns.to_csv(f"data/data_{index}_ceir_returns.csv")

print("\nFiles saved")

print(f"data/data_{index}_ceir_weights.csv")
print(f"data/data_{index}_ceir_optimization_history.csv")
print(f"data/data_{index}_ceir_returns.csv")