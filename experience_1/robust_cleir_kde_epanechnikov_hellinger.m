...
weightFile = fullfile( ...
    "data", ...
    "data_" + index + ...
    "_robust_cleir_kde_epanechnikov_hellinger_weights.csv" ...
);

optimizationFile = fullfile( ...
    "data", ...
    "data_" + index + ...
    "_robust_cleir_kde_epanechnikov_hellinger_optimization_history.csv" ...
);

returnsFile = fullfile( ...
    "data", ...
    "data_" + index + ...
    "_robust_cleir_kde_epanechnikov_hellinger_returns.csv" ...
);
