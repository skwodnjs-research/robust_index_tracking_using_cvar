...
weight_history.to_csv(f"data/data_{index}_robust_cleir_wasserstein_weights.csv")
optimization_history.to_csv(f"data/data_{index}_robust_cleir_wasserstein_optimization_history.csv")
backtest_returns.to_csv(f"data/data_{index}_robust_cleir_wasserstein_returns.csv")

print("\nFiles saved")

print(f"data/data_{index}_robust_cleir_wasserstein_weights.csv")
print(f"data/data_{index}_robust_cleir_wasserstein_optimization_history.csv")
print(f"data/data_{index}_robust_cleir_wasserstein_returns.csv")