...
robust_po_weight_history = pd.read_csv(
    "../data/exp6_data_sp500_robust_po_alpha=0.95_delta=0.01_weights.csv",
    index_col=0,
    parse_dates=True,
)

robust_po_optimization_history = pd.read_csv(
    "../data/exp6_data_sp500_robust_po_alpha=0.95_delta=0.01_optimization_history.csv",
    index_col=0,
    parse_dates=True,
)

robust_po_backtest_returns = pd.read_csv(
    "../data/exp6_data_sp500_robust_po_alpha=0.95_delta=0.01_returns.csv",
    index_col=0,
    parse_dates=True,
)
...
#     "../data/exp6_data_sp500_robust_po_lasso_alpha=0.95_delta=0.01_weights.csv",
#     index_col=0,
#     parse_dates=True,
# )

# robust_po_lasso_optimization_history = pd.read_csv(
#     "../data/exp6_data_sp500_robust_po_lasso_alpha=0.95_delta=0.01_optimization_history.csv",
#     index_col=0,
#     parse_dates=True,
# )

# robust_po_lasso_backtest_returns = pd.read_csv(
#     "../data/exp6_data_sp500_robust_po_lasso_alpha=0.95_delta=0.01_returns.csv",
#     index_col=0,
#     parse_dates=True,
# )
...
#     "../data/exp6_data_sp500_robust_po_with_return_const_alpha=0.95_delta=0.01_weights.csv",
#     index_col=0,
#     parse_dates=True,
# )

# robust_po_with_return_const_optimization_history = pd.read_csv(
#     "../data/exp6_data_sp500_robust_po_with_return_const_alpha=0.95_delta=0.01_optimization_history.csv",
#     index_col=0,
#     parse_dates=True,
# )

# robust_po_with_return_const_backtest_returns = pd.read_csv(
#     "../data/exp6_data_sp500_robust_po_with_return_const_alpha=0.95_delta=0.01_returns.csv",
#     index_col=0,
#     parse_dates=True,
# )
...
#     "../data/exp6_data_sp500_robust_po_lasso_with_return_const_alpha=0.95_delta=0.01_weights.csv",
#     index_col=0,
#     parse_dates=True,
# )

# robust_po_lasso_with_return_const_optimization_history = pd.read_csv(
#     "../data/exp6_data_sp500_robust_po_lasso_with_return_const_alpha=0.95_delta=0.01_optimization_history.csv",
#     index_col=0,
#     parse_dates=True,
# )

# robust_po_lasso_with_return_const_backtest_returns = pd.read_csv(
#     "../data/exp6_data_sp500_robust_po_lasso_with_return_const_alpha=0.95_delta=0.01_returns.csv",
#     index_col=0,
#     parse_dates=True,
# )
...
plt.plot(
    ...
    robust_po_backtest_returns["benchmark"],
    label="S&P500",
    linewidth=0.8,
    alpha=0.8,
)
...
plt.plot(
    ...
    wass_ceir_cumulative["benchmark"],
    label="S&P500",
    linewidth=0.8,
    alpha=0.8,
)
