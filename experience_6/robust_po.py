...
for rebalance_month in rebalance_months:
    ...
    try:
        w_value, objective_value, status = solve_robust_po(
...
weight_history.to_csv(f"../data/exp6_data_{index}_robust_po_alpha={alpha}_delta={delta}_weights.csv")
optimization_history.to_csv(f"../data/exp6_data_{index}_robust_po_alpha={alpha}_delta={delta}_optimization_history.csv")
backtest_returns.to_csv(f"../data/exp6_data_{index}_robust_po_alpha={alpha}_delta={delta}_returns.csv")

print("\nFiles saved")

print(f"../data/exp6_data_{index}_robust_po_alpha={alpha}_delta={delta}_weights.csv")
print(f"../data/exp6_data_{index}_robust_po_alpha={alpha}_delta={delta}_optimization_history.csv")
print(f"../data/exp6_data_{index}_robust_po_alpha={alpha}_delta={delta}_returns.csv")