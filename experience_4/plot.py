...
wass_ceir_v1_weight_history = pd.read_csv(
    f"../data/exp4_data_sp500_wass_ceir_alpha=0.95_delta=0.01_weights_v1.csv",
    index_col=0,
    parse_dates=True,
)

wass_ceir_v1_optimization_history = pd.read_csv(
    f"../data/exp4_data_sp500_wass_ceir_alpha=0.95_delta=0.01_optimization_history_v1.csv",
    index_col=0,
    parse_dates=True,
)

wass_ceir_v1_backtest_returns = pd.read_csv(
    f"../data/exp4_data_sp500_wass_ceir_alpha=0.95_delta=0.01_returns_v1.csv",
    index_col=0,
    parse_dates=True,
)
...
wass_ceir_v2_weight_history = pd.read_csv(
    f"../data/exp4_data_sp500_wass_ceir_alpha=0.95_delta=0.01_weights_v2.csv",
    index_col=0,
    parse_dates=True,
)

wass_ceir_v2_optimization_history = pd.read_csv(
    f"../data/exp4_data_sp500_wass_ceir_alpha=0.95_delta=0.01_optimization_history_v2.csv",
    index_col=0,
    parse_dates=True,
)

wass_ceir_v2_backtest_returns = pd.read_csv(
    f"../data/exp4_data_sp500_wass_ceir_alpha=0.95_delta=0.01_returns_v2.csv",
    index_col=0,
    parse_dates=True,
)
...
plt.title("CEIR : Out-of-sample Backtest : version 1")
plt.legend()
plt.grid(alpha=0.3)
plt.tight_layout()
