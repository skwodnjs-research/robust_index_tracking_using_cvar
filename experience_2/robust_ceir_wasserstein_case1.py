...
def solve_robust_ceir_wasserstein(
    ...
    for i in range(n):
        ...
        support_i1 = cp.sum(cp.maximum(L * nu_i1, U * nu_i1))
        ...
        support_i2 = cp.sum(cp.maximum(L * nu_i2, U * nu_i2))
...
weight_history.to_csv(f"data/data_{index}_wass_ceir_alpha={alpha}_delta={delta}_weights_case1.csv")
optimization_history.to_csv(f"data/data_{index}_wass_ceir_alpha={alpha}_delta={delta}_optimization_history_case1.csv")
backtest_returns.to_csv(f"data/data_{index}_wass_ceir_alpha={alpha}_delta={delta}_returns_case1.csv")

print("\nFiles saved")

print(f"data/data_{index}_wass_ceir_alpha={alpha}_delta={delta}_weights_case1.csv")
print(f"data/data_{index}_wass_ceir_alpha={alpha}_delta={delta}_optimization_history_case1.csv")
print(f"data/data_{index}_wass_ceir_alpha={alpha}_delta={delta}_returns_case1.csv")