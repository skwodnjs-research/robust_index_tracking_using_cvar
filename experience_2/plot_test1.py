...
# ------------------------------------------------------------
# Robust Index Tracking + Wasserstein
# ------------------------------------------------------------
...
# 누적수익률
wass_ceir_case1_cumulative = (1 + wass_ceir_case1_backtest_returns).cumprod()
wass_ceir_case2_cumulative = (1 + wass_ceir_case2_backtest_returns).cumprod()
wass_cleir_case1_cumulative = (1 + wass_cleir_case1_backtest_returns).cumprod()
wass_cleir_case2_cumulative = (1 + wass_cleir_case2_backtest_returns).cumprod()
wass_it_cumulative = (1 + wass_it_backtest_returns).cumprod()

# 사용 종목 수
tol = 1e-6

wass_ceir_case1_l0_norm = (wass_ceir_case1_weight_history.abs() > tol).sum(axis=1)
wass_ceir_case2_l0_norm = (wass_ceir_case2_weight_history.abs() > tol).sum(axis=1)
wass_cleir_case1_l0_norm = (wass_cleir_case1_weight_history.abs() > tol).sum(axis=1)
wass_cleir_case2_l0_norm = (wass_cleir_case2_weight_history.abs() > tol).sum(axis=1)
wass_it_l0_norm = (wass_it_weight_history.abs() > tol).sum(axis=1)
...
plt.plot(
    wass_ceir_case1_backtest_returns.index,
    wass_ceir_case1_backtest_returns["benchmark"],
    label="S&P500",
    linewidth=0.8,
    alpha=0.8,
)
...
plt.plot(
    wass_ceir_case1_backtest_returns.index,
    wass_ceir_case1_backtest_returns["portfolio"],
...
plt.plot(
    wass_ceir_case2_backtest_returns.index,
    wass_ceir_case2_backtest_returns["portfolio"],
...
plt.plot(
    wass_it_backtest_returns.index,
    wass_it_backtest_returns["portfolio"],
    label="RIT + Wasserstein (delta=0.01)",
    linewidth=0.5,
    alpha=0.5,
)
...
plt.plot(
    wass_cleir_case1_backtest_returns.index,
    wass_cleir_case1_backtest_returns["benchmark"],
    label="S&P500",
    linewidth=0.8,
    alpha=0.8,
)
...
plt.plot(
    wass_cleir_case1_backtest_returns.index,
    wass_cleir_case1_backtest_returns["portfolio"],
...
plt.plot(
    wass_cleir_case2_backtest_returns.index,
    wass_cleir_case2_backtest_returns["portfolio"],
...
plt.plot(
    wass_ceir_case1_cumulative.index,
...
plt.plot(
    wass_ceir_case2_cumulative.index,
...
plt.plot(
    wass_it_cumulative.index,
    wass_it_cumulative["portfolio"],
    label="RIT + Wasserstein (delta=0.01)",
    linewidth=0.5,
    alpha=0.5,
)
...
plt.plot(
    wass_cleir_case1_cumulative.index,
...
plt.plot(
    wass_cleir_case2_cumulative.index,
...
# 2.2.1 CEIR + Wasserstein : Case 1
plot_weight_history(
    weight_history=wass_ceir_case1_weight_history,
    title=(
...
# 2.2.2 CEIR + Wasserstein : Case 2
plot_weight_history(
    weight_history=wass_ceir_case2_weight_history,
    title=(
        "Portfolio Composition "
...
# 2.2.3 CLEIR + Wasserstein : Case 1
plot_weight_history(
    weight_history=wass_cleir_case1_weight_history,
    title=(
        "Portfolio Composition "
...
# 2.2.4 CLEIR + Wasserstein : Case 2
plot_weight_history(
    weight_history=wass_cleir_case2_weight_history,
    title=(
        "Portfolio Composition "
...
# 2.2.5 Robust Index Tracking + Wasserstein
plot_weight_history(
    weight_history=wass_it_weight_history,
    title=(
        "Portfolio Composition "
        "(RIT + Wasserstein, delta=0.01)"
    ),
)
